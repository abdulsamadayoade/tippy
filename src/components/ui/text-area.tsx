      ...
      <div className={cn("w-full", containerClassName)}>
        ...
        <div className={cn("group/textarea relative", controlClassName)}>
          <textarea
            ...
            id={textareaId}
            className={cn(
              "block min-h-16.5 w-full resize-none rounded-xl border-0 bg-form-input-bg px-3.5 pt-3 text-base sm:text-sm leading-[1.4] text-body-text shadow-surface outline-none transition-shadow duration-150 ease-out placeholder:text-muted-text focus:shadow-[inset_0_0_0_1px_var(--color-primary),0_0_0_4px_rgba(6,78,91,0.12),0_4px_12px_rgba(6,78,91,0.08)] disabled:cursor-not-allowed disabled:opacity-60",
              invalid &&
